	...
	return (
		<>
			...
			<motion.button
				...
				whileTap={{ scale: 0.95 }}
				onClick={handleEdit}
				className='fixed top-16 right-6 z-50 rounded-xl border bg-white/60 px-6 py-2 text-sm backdrop-blur-sm transition-colors hover:bg-white/80 max-sm:hidden'>
				编辑
			</motion.button>
