    ...
    return (
        <div className="flex flex-col items-center px-6 pt-32 pb-12 min-h-[80vh]">
            ...
            >
                ...
                <div className='bg-brand mt-4 h-1 w-16 mx-auto rounded-full' />
            </motion.div>

            {loading ? (
                <div className="flex flex-col items-center gap-4 animate-pulse">
                    <div className="w-12 h-12 bg-secondary/10 rounded-full border-2 border-brand/20 border-t-brand animate-spin" />
