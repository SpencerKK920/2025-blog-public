						...
						<div className='flex flex-col gap-6'>
							...
							<div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
								...
								<motion.div 
									...
									className='md:col-span-2 card p-8 md:p-12 min-h-[400px]'
								>
									<h3 className='font-averia text-2xl italic mb-8 text-brand'>Vision & Story</h3>
								...
								<motion.div 
									...
									className='bg-brand/5 border border-brand/10 rounded-[32px] p-8 flex flex-col justify-between'
								>
									<div>
							...
							>
								...
								<div className='flex flex-wrap gap-3'>
									...
									{['Next.js', 'React', 'TypeScript', 'Tailwind', 'Motion', 'Github API', 'Vercel', 'Sonner'].map(tech => (
										<span key={tech} className='px-4 py-2 bg-secondary/5 border rounded-full text-[11px] font-mono hover:border-brand/40 transition-all cursor-default'>
											{tech}
										</span>
									))}
								</div>
