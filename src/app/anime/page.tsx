...
export default function AnimePage() {
    ...
    return (
        <>
            {/* 核心修复：通过 meta 标签全局禁用 Referer，绕过 B 站图片防盗链 */}
            <meta name="referrer" content="no-referrer" />
            
            <div className='flex flex-col items-center px-6 pt-32 pb-12'>
                {/* 页面头部：参考 RyuChan 的 Heading 风格 */}
                ...
                {loading ? (
                    <div className='text-brand animate-pulse'>正在同步 Bilibili 数据...</div>
                ) : (
                    /* 网格布局：参考 RyuChan 的响应式断点 */
