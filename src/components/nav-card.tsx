...
import BookshelfOutlineSVG from '@/svgs/bookshelf-outline.svg'
import BookshelfFilledSVG from '@/svgs/bookshelf-filled.svg'
...
const list = [
   {
        icon: BookshelfOutlineSVG,
        iconActive: BookshelfFilledSVG,
        label: '知识库',
        href: '/kb'
    },
	   {
